...
:runWrapper
@REM Find the maven wrapper jar in the project base directory
...
@REM Start Java VM
@REM Use MAVEN_OPTS to set JVM options for the Maven process
@REM Use MAVEN_SKIP_RC to skip loading of mavenrc files

set MAVEN_CMD_LINE_ARGS=%*

%JAVA_HOME%\bin\java %MAVEN_OPTS% -classpath %WRAPPER_JAR% "-Dmaven.multiModuleProjectDirectory=%MAVEN_PROJECTBASEDIR%" org.apache.maven.wrapper.MavenWrapperMain %MAVEN_CMD_LINE_ARGS%
